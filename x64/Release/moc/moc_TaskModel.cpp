...
void TaskModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->taskCreated((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        case 1: _t->taskDeleted(); break;
        case 2: _t->taskUpdated((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        case 3: _t->tasksFetched((*reinterpret_cast< std::add_pointer_t<QJsonArray>>(_a[1]))); break;
        ...
        {
            using _t = void (TaskModel::*)(const QJsonObject & );
        ...
        {
            using _t = void (TaskModel::*)(const QJsonArray & );
...
// SIGNAL 0
void TaskModel::taskCreated(const QJsonObject & _t1)
{
...
// SIGNAL 2
void TaskModel::taskUpdated(const QJsonObject & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void TaskModel::tasksFetched(const QJsonArray & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
