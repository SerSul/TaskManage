...
static constexpr auto qt_meta_stringdata_CLASSMainControllerENDCLASS = QtMocHelpers::stringData(
    "MainController",
    "handleChangeVisibillity",
    "",
    "token"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSMainControllerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSMainControllerENDCLASS_t qt_meta_stringdata_CLASSMainControllerENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14),  // "MainController"
        QT_MOC_LITERAL(15, 23),  // "handleChangeVisibillity"
        QT_MOC_LITERAL(39, 0),  // ""
        QT_MOC_LITERAL(40, 5)   // "token"
    },
    "MainController",
    "handleChangeVisibillity",
    "",
...
Q_CONSTINIT const QMetaObject MainController::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainControllerENDCLASS_t,
        ...
        // method 'handleChangeVisibillity'
...
void MainController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->handleChangeVisibillity((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
